...
const Stopy = {
  ...
  SEZNAM: [
    { id:'zadna',    jmeno:'None',      cena:0,
      barvy:['#9db4cf'] },
    { id:'jiskry',   jmeno:'Embers',    cena:1,
      barvy:['#ffb347','#ff8c42','#ffd98a'] },
    { id:'mraz',     jmeno:'Frost',     cena:1,
      barvy:['#9fe4ff','#cdf3ff','#6fc9e8'] },
    { id:'kvety',    jmeno:'Petals',    cena:1,
      barvy:['#f2a6c4','#ffd6e8','#f4efe4'] },
    { id:'bubliny',  jmeno:'Bubbles',   cena:1,
      barvy:['#7fd8d8','#a8ecec','#4fa3c9'] },
    { id:'stin',     jmeno:'Shadow',    cena:1,
      barvy:['#3a3f4a','#232830','#565f6e'] },
    { id:'duha',     jmeno:'Rainbow',   cena:1,
      barvy:['#e0748a','#ffb347','#ffe98a','#7fc99a','#9fe4ff','#c9a8f2'] },
    { id:'hvezdny',  jmeno:'Stardust',  cena:1,
